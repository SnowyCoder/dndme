...
(async function() {
  console.log("Loading dndme: v1.4.3\n");
  stage.setPhase(new LoadingPhase());
  await (await __vitePreload(() => import("./secondPhase.78872ccc.js"), true ? ["assets/secondPhase.78872ccc.js","assets/secondPhase.7292b19a.css"] : void 0)).start();
})();
export {
  createVNode as A,
  withCtx as B,
...
//# sourceMappingURL=index.cfbdc326.js.map
