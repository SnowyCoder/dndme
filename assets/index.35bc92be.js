...
(async function() {
  console.log("Loading dndme: v1.4.4\n");
  stage.setPhase(new LoadingPhase());
  await (await __vitePreload(() => import("./secondPhase.06b2f3fb.js"), true ? ["assets/secondPhase.06b2f3fb.js","assets/secondPhase.7292b19a.css"] : void 0)).start();
})();
export {
  createVNode as A,
  withCtx as B,
...
//# sourceMappingURL=index.35bc92be.js.map
