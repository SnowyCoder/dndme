...
const _hoisted_3 = /* @__PURE__ */ createBaseVNode("h5", null, "Loading", -1);
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("div", _hoisted_1, [
      _hoisted_2,
      createBaseVNode("h2", null, toDisplayString(_ctx.message), 1),
      _hoisted_3
    ])
  ]);
}
const LoadingComponent = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
...
(async function() {
  console.log("Loading dndme: v1.4.4-1-gb181dce\n");
  stage.setPhase(new LoadingPhase());
  await (await __vitePreload(() => import("./secondPhase.02f1533e.js"), true ? ["assets/secondPhase.02f1533e.js","assets/secondPhase.7292b19a.css"] : void 0)).start();
})();
export {
  createVNode as A,
  withCtx as B,
...
//# sourceMappingURL=index.bd903d2d.js.map
