...
class Stage extends Phase {
  constructor(name) {
    super(name);
    __publicField(this, "phase", null);
  }
  setPhase(phase) {
    if (this.phase)
      this.phase.disable();
...
const _hoisted_1 = { class: "sloading-container" };
const _hoisted_2 = /* @__PURE__ */ createBaseVNode("h1", { class: "sloading-title" }, "DRAW&DICE", -1);
    ...
    const state = computed(() => {
      switch (props.status.value) {
        case "loading":
          return "Loading";
        case "sw_register":
          return "Registering SW";
        case "sw_error":
          return "Error while registering service worker";
        default:
          return "ERROR: " + props.status;
      }
    });
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", null, [
        createBaseVNode("div", _hoisted_1, [
          _hoisted_2,
          createBaseVNode("h2", null, toDisplayString(unref(message)), 1),
          createBaseVNode("h5", null, toDisplayString(unref(state)), 1)
        ])
      ]);
    };
  }
...
class LoadingPhase extends Phase {
  constructor() {
    super("loading");
    __publicField(this, "state", shallowRef("sw_register"));
  }
  ui() {
    return createApp(_sfc_main, {
      status: this.state
    });
  }
  update(state) {
...
function registerSW(options = {}) {
  ...
  async function register() {
    if ("serviceWorker" in navigator) {
      const { Workbox } = await __vitePreload(() => import("./workbox-window.prod.es5.e0cc53cf.js"), true ? [] : void 0);
      wb = new Workbox("/dndme/sw.js", { scope: "/dndme/", type: "classic" });
...
const UPDATE_CHECK_INTERVAL = 15 * 60 * 1e3;
const versionReady = shallowRef(null);
        ...
        registration.addEventListener("updatefound", () => {
          ...
          const eventListener = async () => {
            if (usw.state == "activated") {
              ...
              const version2 = await fetch("version").then((x) => x.text());
              console.log("Update version: ", version2);
              res.events.emit("updateactive", version2);
              versionReady.value = version2;
            }
          };
          usw.addEventListener("statechange", eventListener);
          eventListener();
        });
        setInterval(() => registration == null ? void 0 : registration.update(), UPDATE_CHECK_INTERVAL);
        resolve2(res);
      },
      onRegisterError(e) {
...
(async function() {
  console.log("Loading dndme: v1.5.1\n");
  ...
  await (await __vitePreload(() => import("./secondPhase.a4c50769.js"), true ? ["assets/secondPhase.a4c50769.js","assets/secondPhase.7292b19a.css"] : void 0)).start();
})();
export {
...
//# sourceMappingURL=index.8dbc21da.js.map
