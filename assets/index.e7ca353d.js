...
(async function() {
  console.log("Loading dndme: v1.4.2\n");
  stage.setPhase(new LoadingPhase());
  await (await __vitePreload(() => import("./secondPhase.fd140fbb.js"), true ? ["assets/secondPhase.fd140fbb.js","assets/secondPhase.7292b19a.css"] : void 0)).start();
})();
export {
  createVNode as A,
  withCtx as B,
...
//# sourceMappingURL=index.e7ca353d.js.map
