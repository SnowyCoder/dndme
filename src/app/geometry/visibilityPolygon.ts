...
// a < b
function segmentLt(a: Segment, b: Segment, o: StupidPoint): boolean {
...
function initSegment(x1: number, y1: number, x2: number, y2: number, pos: StupidPoint): Segment {
...
function compute0(pos: StupidPoint, segments: Segment[]): Array<number> {
...
function clipSegment(line: Line, aabb: Aabb, light: StupidPoint): Segment | undefined {
